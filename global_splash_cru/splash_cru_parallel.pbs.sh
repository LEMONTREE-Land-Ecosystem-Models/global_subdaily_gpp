...
BASEPATH="/rds/general/project/lab-prentice-realm-data/live/splash_CRU/"

# Stage the input files to avoid issues with multiple jobs reading them

cp $BASEPATH/cru_2001_2020_tmp.nc $TMPDIR/cru_2001_2020_tmp.nc
cp $BASEPATH/cru_2001_2020_pre.nc $TMPDIR/cru_2001_2020_pre.nc
cp $BASEPATH/cru_2001_2020_cld.nc $TMPDIR/cru_2001_2020_cld.nc
cp $BASEPATH/Asurf_land_cells.nc $TMPDIR/Asurf_land_cells.nc
...
python3 $BASEPATH/py_version/splash_CRU_cli.py \
    ...
    --out $BASEPATH/results_block_${PBS_ARRAY_INDEX}.nc \
